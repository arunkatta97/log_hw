...
def before_request_logging():
    ...
    log.info("Debug Level Function Has Been Triggered")
...
LOGGING_CONFIG = {
    ...
    'handlers': {
        ...
        'file.handler.debuglog': {
            'class': 'logging.handlers.RotatingFileHandler',
            'formatter': 'DebugFormatter',
            'filename': 'app/logs/debuglog.log',
            'maxBytes': 10000000,
            'backupCount': 5,
        },
    },
    'loggers': {
        ...
        'Debuglog': {  # if __name__ == '__main__'
            'handlers': ['file.handler.debuglog'],
            'level': 'DEBUG',
            'propagate': False
        },
